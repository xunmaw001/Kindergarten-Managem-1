              ...
              <div v-else>
                <el-form-item v-if="ruleForm.kechengjieshao" label="课程介绍" prop="kechengjieshao">
                    <span>{{ruleForm.kechengjieshao}}</span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="课程特色" prop="kechengtese">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="课程特色"
                  v-model="ruleForm.kechengtese" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kechengtese" label="课程特色" prop="kechengtese">
                    <span>{{ruleForm.kechengtese}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="课程表" prop="kechengbiao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.kechengbiao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kechengbiao" label="课程表" prop="kechengbiao">
                    <span v-html="ruleForm.kechengbiao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kechengjieshao = true;
            continue;
	            	            ...
	            	            if(o=='kechengtese'){
            this.ruleForm.kechengtese = obj[o];
	    this.ro.kechengtese = true;
            continue;
          }
	            	            if(o=='kechengbiao'){
