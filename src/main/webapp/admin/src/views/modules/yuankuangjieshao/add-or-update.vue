          ...
          <el-form-item class="input" v-if="ruleForm.faburiqi" label="发布日期" prop="faburiqi">
              <el-input v-model="ruleForm.faburiqi" 
                placeholder="发布日期" readonly></el-input>
                                                                                                                  ...
                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="特色介绍" prop="tesejieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.tesejieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tesejieshao" label="特色介绍" prop="tesejieshao">
                    <span v-html="ruleForm.tesejieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='tesejieshao'){
            this.ruleForm.tesejieshao = obj[o];
	    this.ro.tesejieshao = true;
            continue;
          }
	            	            if(o=='faburiqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yuankuangjieshao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yuankuangjieshaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
