        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.banji"
                placeholder="班级" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="老师邮箱" prop="laoshiyouxiang">
          <el-input v-model="ruleForm.laoshiyouxiang" 
              placeholder="老师邮箱" clearable  :readonly="ro.laoshiyouxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="老师邮箱" prop="laoshiyouxiang">
              <el-input v-model="ruleForm.laoshiyouxiang" 
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.banji = true;
            continue;
	            	            ...
	            	            if(o=='laoshiyouxiang'){
            this.ruleForm.laoshiyouxiang = obj[o];
	    this.ro.laoshiyouxiang = true;
            continue;
          }
	            	            if(o=='shouji'){
